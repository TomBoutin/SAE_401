...
<nav
  ...
  <div className="flex w-full flex-wrap items-center justify-between px-3"> 
    ...
    <div className="list-style-none me-auto flex flex-col ps-0 lg:flex-row text-blue-500 space-x-10">
        ...
        <div className="list-style-none me-auto flex flex-col ps-0 lg:flex-row text-white space-x-10">
          ...
          <Link className="mb-4 lg:mb-0 lg:pe-2 hover:text-[#BBA] focus:text-[#BB0]" to="/Linkbout">?</Link>
        </div>
