...
export default function Card_Horizontal({ className, id, name, realisateur, annee_sortie, affiche_horizontale}) {
  ...
  return (
    <div id={id} className={`${className} list-none group relative h-52 w-88 cursor-pointer before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-cardGradiant before:opacity-0 hover:before:opacity-100 font-openSans before:transform before:transition-all before:duration-200 duration-300 transition-all hover:outline outline-offset-1 outline-main z-3 hover:scale-105`}>
